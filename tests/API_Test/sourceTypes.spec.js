...
test('API_SourceTypes_Test: Capture cookies and call SourceTypes API', async ({ page }) => {
  let cookies = '';
  ...
  const apiUrl = apiEndpoints.sourceTypesApi; // Ensure this is defined in apiEndpoints.json
