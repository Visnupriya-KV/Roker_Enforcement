...
import paymentSearchRequestBody from '../../data/API_JSON/paymentSearchRequestBody.json';

test('API_PaymentSearch_Test: Capture cookies and call Payment Search API', async ({ page }) => {
  let cookies = '';
  ...
  const apiUrl = apiEndpoints.paymentSearchApi; // Ensure this is defined in apiEndpoints.json
  console.log('Making API call to:', apiUrl);

  const response = await apiContext.post(apiUrl, {
    data: paymentSearchRequestBody, // Pass the request body from JSON
  });
