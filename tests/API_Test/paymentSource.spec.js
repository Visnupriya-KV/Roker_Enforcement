...
test('API_PaymentSource_Test: Capture cookies and call PaymentSource API', async ({ page }) => {
  let cookies = '';
  ...
  const apiUrl = apiEndpoints.paymentSourceApi; // Ensure this is defined in apiEndpoints.json
