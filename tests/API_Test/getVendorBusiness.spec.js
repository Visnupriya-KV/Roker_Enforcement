...
test('API_GetVendorBusiness_Test: Capture cookies and call Vendor API', async ({ page }) => {
  let cookies = '';
  ...
  // Step 5: API endpoint from apiEndpoints.json
  const apiUrl = apiEndpoints.getVendorBusiness;
