...
test('API_PaymentMethod_Test: Capture cookies and call PaymentMethod API', async ({ page }) => {
  let cookies = '';
  ...
  const apiUrl = apiEndpoints.paymentMethodApi; // Ensure this is defined in apiEndpoints.json
