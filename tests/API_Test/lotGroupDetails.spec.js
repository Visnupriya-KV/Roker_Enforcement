...
test('API_LotGroupDetails_Test: Login and capture cookies for Group API call', async ({ page }) => {
  let cookies = '';
  ...
  const apiUrl = apiEndpoints.groupApi; // Ensure this is defined in apiEndpoints.json
