...
test('API_TransactionType_Test: Capture cookies and call TransactionType API', async ({ page }) => {
  let cookies = '';
  ...
  const apiUrl = apiEndpoints.transactionTypeApi; // Ensure this is defined in apiEndpoints.json
