...
test('API_PlateActivityList_Test: Capture cookies and call PlateActivityList API', async ({ page }) => {
  let cookies = '';
  ...
  const apiUrl = apiEndpoints.plateActivityListApi; // Ensure this is defined in apiEndpoints.json
