...
test('API_AcceptedDocument_Test: Capture cookies and call Patroller API', async ({ page }) => {
  let cookies = '';
  ...
  const apiUrl = apiEndpoints.acceptedDocument; // define this in apiEndpoints.json
  ...
  // Example: if response contains "patrollerId"
