...
test('API_ProvinceState_Test: Capture cookies and call ProvinceState API', async ({ page }) => {
  let cookies = '';
  ...
  const apiUrl = apiEndpoints.provinceStateApi; // must be defined in apiEndpoints.json
