...
test('API_PlateActivityTypeMaster_Test: Capture cookies and call PlateActivityTypeMaster API', async ({ page }) => {
  let cookies = '';
  ...
  const apiUrl = apiEndpoints.plateActivityTypeMasterApi; // Ensure this is defined in apiEndpoints.json
